...
db.registerUser = function(data, userData) {
    ...
    con.query(
        q, [data.full_name, data.email, data.password],
        function(err, result) {
            if (!err) {
...
db.updateUser = function(data, id) {
    ...
    con.query(
        q, [id, data.full_name, data.email, data.password, id],
        function(err, result) {
            if (err) {
                console.log(err);
            }
...
db.createCustomer = function(data) {
    ...
    con.query(
        q, [data.full_name, data.email, data.phone_num],
        function(err, result) {
            if (!err) {
                console.log(result);
            } else {
...
db.updateCustomer = function(data, id) {
    ...
    con.query(
        q, [id, data.full_name, data.email, data.phone_num, id],
        function(err, result) {
            if (!err) {
                console.log(result);
            } else {
...
db.createItems = function(data) {
    ...
    con.query(
        q, [data.item_name, data.item_price, data.item_quntitny],
        function(err, result) {
            if (err) {
                console.log(err);
            }
...
db.UpdateItems = function(data, id) {
    ...
    con.query(
        q, [id, data.item_name, data.item_price, data.item_quntitny, id],
        function(err, result) {
            if (!err) {
                console.log(result);
            }
...
db.createInvoice = function(data) {
    ...
    con.query(
        q, [data.total_price, data.customer_id, data.supplier_id],
        function(err, result) {
            if (!err) {
                console.log(result);
            } else {
...
db.updateInvoice = function(data, id) {
    ...
    con.query(
        q, [id, data.total_price, data.customer_id, data.supplier_id, id],
        function(err, result) {
            if (!err) {
                console.log(result);
            } else {
